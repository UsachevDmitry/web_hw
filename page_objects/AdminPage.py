...
class AdminPage(BasePage):
    ...
    USERNAME_INPUT_ID = (By.ID, "#input-username")
    ...
    def check_user_name(self):
        return self._verify_element_visibility(self.USERNAME_INPUT).get_attribute("placeholder")

    def check_user_password(self):
        return self._verify_element_visibility(self.PASSWORD_INPUT).get_attribute("placeholder")

    def check_forgotten_password(self):
        return self._verify_element_visibility(self.FORGOTTEN_PASSWORD).text

    def check_button_login(self):
        return self._verify_element_visibility(self.SAVE_BTN)
